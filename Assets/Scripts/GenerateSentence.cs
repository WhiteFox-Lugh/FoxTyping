...
public class GenerateSentence {
	...
	private List<(string jp, string h)> qJP1 = new List<(string jp, string h)>() {
		...
		("目には目を、歯には$", "めにはめを、はには$"), ("我輩は$である", "わがはいは$である"), ("お値段異常$", "おねだんいじょう$"),
		...
		("志望動機は$", "しぼうどうきは$"), ("好きです、$", "すきです、$"), ("ショートコント、$", "しょーとこんと、$"), ("正解は$", "せいかいは$"),
		...
		("$って言う方が$", "$っていうほうが$"), ("目も当てられないほどお粗末な$", "めもあてられないほどおそまつな$"),
		...
		("赤い$と緑のたぬき", "あかい$とみどりのたぬき"), ("キャッシュレス$還元", "きゃっしゅれす$かんげん"), ("俺たちの$", "おれたちの$"), ("すべての$をしまえ", "すべての$をしまえ"),
		("台風なのに出社させる$", "たいふうなのにしゅっしゃさせる$"), ("スラーとタイをよく間違える$", "すらーとたいをよくまちがえる$"),
		("足し算を間違える$", "たしざんをまちがえる$"), ("増税しても$は変わらない", "ぞうぜいしても$はかわらない"),
		("展覧会の$", "てんらんかいの$"), ("メイドイン$", "めいどいん$"), ("$なしでは生きていけない", "$なしではいきていけない"),
		("名探偵$", "めいたんてい$"), ("1限は$だと言い張る", "1限は$だと言い張る"), ("行けたら行く、そう言って$は消えた", "いけたらいく、そういって$はきえた"),
		("身から出た$", "みからでた$"), ("サルでもわかる$入門", "さるでもわかる$にゅうもん"), ("ゼロからはじめる$", "ぜろからはじめる$"),
		("月に$が存在していることを確認", "つきに$がそんざいしていることをかくにん"), ("$をぶっ壊す", "$をぶっこわす"),
		("刺身に$を乗せる仕事", "さしみに$をのせるしごと"), ("学歴マウントしかできない$", "がくれきまうんとしかできない$"),
		("もう$しか聞こえない", "もう$しかきこえない"), ("積分定数は$とする", "せきぶんていすうは$とする"),
		("ロピタルの定理を裏技だと思っている$", "ろぴたるのていりをうらわざだとおもっている$"),
		("桃栗三年$八年", "ももくりさんねん$はちねん"), ("すももも$ももものうち", "すももも$ももものうち"),
		("積分と極限を勝手に交換する$", "せきぶんときょくげんをかってにこうかんする$"), ("はさみうちの原理にはさまれる$", "はさみうちのげんりにはさまれる$"),
		("印鑑はセキュアだと言い張る$", "いんかんはせきゅあだといいはる$"), ("$の角に頭をぶつける", "$のかどにあたまをぶつける"),
		("ようこそ$へ", "ようこそ$へ"), ("ドは$のド", "どは$のど"), ("苦しんで覚える$", "くるしんでおぼえる$"),
		("$、完全に理解した", "$、かんぜんにりかいした"), ("$、何もわからない", "$、なにもわからない"),
		("$、チョットデキル", "$、ちょっとできる"), ("鬼の目にも$", "おにのめにも$"), ("一寸先は$", "いっすんさきは$"),
		("母なる$を讃えよ", "ははなる$をたたえよ"), ("$の嫁入り", "$のよめいり"), ("うたかたの$", "うたかたの$"),
		("梅酒の$割り", "うめしゅの$わり"), ("笑う門には$来たる", "わらうかどには$きたる"), ("青菜に$", "あおなに$"),
		("同じ穴の$", "おなじあなの$"), ("苛政は$よりも猛し", "かせいは$よりもたけし"), ("$の川流れ", "$のかわながれ"),
		("可愛い子には$をさせよ", "かわいいこには$をさせよ"), ("$の交わり", "$のまじわり"), ("$も鳴かずば撃たれまい", "$もなかずばうたれまい"),
		("九死に$を得る", "きゅうしに$をえる"), ("$は百薬の長", "$はひゃくやくのちょう"), ("とんびが$を生む", "とんびが$をうむ"),
		("$なき里のこうもり", "$なきさとのこうもり"), ("三つ子の魂$まで", "みつごのたましい$まで"), ("$の乱", "$のらん"),
		("我思う故に$あり", "われおもうゆえに$あり"), ("$の悪魔", "$のあくま"), ("ラプラスの$", "らぷらすの$"),
		("神の見えざる$", "かみのみえざる$"), ("$逓減の法則", "$ていげんのほうそく"),
		("失われた$", "うしなわれた$"), ("$のカラス", "$のからす"), ("ヘンペルの$", "へんぺるの$")
	};
	...
	private List<(string jp, string h)> qJP2N = new List<(string jp, string h)>() {
		...
		("オーブ", "おーぶ"), ("オリーブオイル", "おりーぶおいる"), ("コンキリエ", "こんきりえ"), ("犬", "いぬ"),
		("マイレージ", "まいれーじ"), ("メンヘラ", "めんへら"), ("アインシュタイン", "あいんしゅたいん"),
		("フックの法則", "ふっくのほうそく"), ("アクリルガッシュ", "あくりるがっしゅ"), ("油絵", "あぶらえ"),
		("シュルレアリスム", "しゅるれありすむ"), ("パレット", "ぱれっと"), ("レタリング", "れたりんぐ"),
		("ミリペン", "みりぺん"), ("ガラスペン", "がらすぺん"), ("色相環", "しきそうかん"), ("補色", "ほしょく"),
		("グレースケール", "ぐれーすけーる"), ("レインボー", "れいんぼー"), ("ハーモニー", "はーもにー"), ("フォルテ", "ふぉるて"),
		("ピアノ", "ぴあの"), ("アクセント", "あくせんと"), ("ヒッコリー", "ひっこりー"), ("メイプル", "めいぷる"),
		("ミュート", "みゅーと"), ("メトロノーム", "めとろのーむ"), ("タクト", "たくと"), ("五線譜", "ごせんふ"),
		("ト音記号", "とおんきごう"), ("ヘ音記号", "へおんきごう"), ("ハ音記号", "はおんきごう"),　("鳩の巣原理", "はとのすげんり"),
		("まち針", "まちばり"), ("ハンドメイド", "はんどめいど"), ("山吹色", "やまぶきいろ"), ("試験管", "しけんかん"),
		("ガスバーナー", "がすばーなー"), ("アルコールランプ", "あるこーるらんぷ"), ("センター試験", "せんたーしけん"),
		("扇状地", "せんじょうち"), ("デルタ", "でるた"), ("三角州", "さんかくす"), ("エトピリカ", "えとぴりか"),
		("ハスカップ", "はすかっぷ"), ("トナカイ", "となかい"), ("シャチ", "しゃち"), ("レプンカムイ", "れぷんかむい"),
		("タンチョウ", "たんちょう"), ("サロルンカムイ", "さろるんかむい"), ("シジュウカラ", "しじゅうから"), ("ゴジュウカラ", "ごじゅうから"),
		("ムクドリ", "むくどり"), ("うちなーぐち", "うちなーぐち"), ("めんそーれ", "めんそーれ"), ("チャンプルー", "ちゃんぷるー"),
		("グスク", "ぐすく"), ("三味線", "しゃみせん"), ("五月雨", "さみだれ"), ("淡雪", "あわゆき"), ("朧月", "おぼろづき"),
		("陽炎", "かげろう"), ("うぐいす", "うぐいす"), ("春告げ鳥", "はるつげどり"), ("空蝉", "うつせみ"),
		("蝉時雨", "せみしぐれ"), ("朝凪", "あさなぎ"), ("いわし雲", "いわしぐも"), ("白露", "はくろ"), ("待宵", "まつよい"),
		("木枯らし", "こがらし"), ("風花", "かざばな"), ("たそがれ時", "たそがれどき"), ("静謐", "せいひつ"),
		("玉響", "たまゆら"), ("熱燗", "あつかん"), ("ぬる燗", "ぬるかん"), ("雪冷え", "ゆきびえ"),
		("花崗岩", "かこうがん"), ("遠日点", "えんじつてん"), ("第一宇宙速度", "だいいちうちゅうそくど"),
		("セントラルドグマ", "せんとらるどぐま"), ("ブロッケン現象", "ぶろっけんげんしょう"), ("フォッサマグナ", "ふぉっさまぐな"),
		("チェルノーゼム", "ちぇるのーぜむ"), ("マグナカルタ", "まぐなかるた")
	};
